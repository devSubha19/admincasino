...
<div class="table-container" id="table1" >
    ...
    <table class="table table-bordered" >
      ...
      @foreach($L6mdata as $l6mdagt)
          <tr scope="row">
              <td>{{$slno++ }}</td>
              <td> <a href="{{route('stockez_turn_repo', ['uname'=> $l6mdagt->stockez_username])}}"> {{$l6mdagt->stockez_username}}</a></td>
              ...
              <td id="admcom">{{$l6mdagt->total_admin_commission}}</td>{{route('stockez_turn_repo', ['uname'=> $l6mdagt->stockez_username])}}
...
<div class="table-container" id="table2">
    ...
    <table class="table table-bordered" >
      ...
      @foreach($Cmdata as $cmd)
          <tr scope="row">
              <td>{{$slno++ }}</td>
              <td> <a href="{{route('stockez_turn_repo', ['uname'=> $cmd->stockez_username])}}"> {{$cmd->stockez_username}}</a></td>
...
<div class="table-container" id="table3">
  ...
  @foreach($Lmdata as $lmd)
      <tr scope="row">
          <td>{{$slno++ }}</td>
          <td> <a href="{{route('stockez_turn_repo', ['uname'=> $lmd->stockez_username])}}"> {{$lmd->stockez_username}}</a></td>
...
<div class="table-container" id="table4">
  ...
  @foreach($Lwdata as $lwd)
      <tr scope="row">
          <td>{{$slno++ }}</td>
          <td> <a href="{{route('stockez_turn_repo', ['uname'=> $lwd->stockez_username])}}"> {{$lwd->stockez_username}}</a></td>
...
<div class="table-container" id="table5">
  ...
  @foreach($Cwdata as $cwd)
      <tr scope="row">
          <td>{{$slno++ }}</td>
          <td> <a href="{{route('stockez_turn_repo', ['uname'=> $cwd->stockez_username])}}"> {{$cwd->stockez_username}}</a></td>
...
<div class="table-container" id="table6">
  ...
  @foreach($Yddata as $ydt)
      <tr scope="row">
          <td>{{$slno++ }}</td>
          <td> <a href="{{route('stockez_turn_repo', ['uname'=> $ydt->stockez_username])}}"> {{$ydt->stockez_username}}</a></td>
...
<div class="table-container" id="table7">
    ...
    <table class="table table-bordered" >
      ...
      @foreach($Tddata as $tdt)
          <tr scope="row">
              <td>{{$slno++ }}</td>
              <td> <a href="{{route('stockez_turn_repo', ['uname'=> $tdt->stockez_username])}}"> {{$tdt->stockez_username}}</td>
