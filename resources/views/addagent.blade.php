 ...
 <section class="main-content">
    <div class="col-md-12">
       <div class="panel panel-primary">
          <div class="panel-heading text-left">Add Agent</div>
          <div class="panel-body">
             <form class="form-horizontal col-md-offset-3" method="POST" action="{{route('saveagent')}}">
               @csrf
                <div class="form-group text-center">
                   <label class="control-label col-sm-2" >Username:</label>
                   <div class="col-sm-6">
                      <input type="text" readonly class="form-control" id="username" value="{{$username}}" placeholder="Enter Your Username" name="username" required>
                   </div>
                </div>
               ...
               <div class="form-group">
                ...
                <div class="form-group">
                   <label class="control-label col-sm-2" name="type" >Select Stockez: </label>
                   <div class="col-sm-6">
                      <select name="stockez" class="form-control" id="" required>
                         <option value="">Select Stockez</option>
                         @foreach($stockez as $sup)
