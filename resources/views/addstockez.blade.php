 ...
 <section class="main-content">
    <div class="col-md-12">
       <div class="panel panel-primary">
          <div class="panel-heading text-left">Add Stockez</div>
          <div class="panel-body">
             <form class="form-horizontal col-md-offset-3" method="POST" action="{{route('savestockez')}}">
               @csrf
                <div class="form-group text-center">
                   <label class="control-label col-sm-2" >Username:</label>
                   <div class="col-sm-6">
                      <input type="text" class="form-control" readonly id="username" value="{{$username}}" placeholder="Enter Your Username" name="username" required>
                   </div>
                </div>
               ...
               <div class="form-group">
                ...
                <!--  <div class="form-group">
                   <label class="control-label col-sm-2" for="pwd"> Stockez:</label>
                   <div class="col-sm-6">          
                ...
                <div class="form-group">
                   <label class="control-label col-sm-2" name="type" >Select SuperStockez: </label>
                   <div class="col-sm-6">
                      <select name="superstockez" class="form-control" id="" required>
