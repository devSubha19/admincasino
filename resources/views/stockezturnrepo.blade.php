...
<h3>stockez turnover report(<span style="color:green">View referrals</span>)</h3>
...
<div class="table-container" id="table1" >
    ...
    <table class="table table-bordered" >
      ...
      @foreach($L6mdata as $l6mdagt)
          ...
          <tr scope="row">
              <td>{{$slno++ }}</td>     
              <td> <a href="{{route('agent_turn_repo', ['uname'=> $l6mdagt->agent_user_name])}}"> {{$l6mdagt->agent_user_name}}</a></td>
...
<div class="table-container" id="table2">
    ...
    <table class="table table-bordered" >
      ...
      @foreach($Cmdata as $cmd)
          <tr scope="row">
              <td>{{$slno++ }}</td>
              <td> <a href="{{route('agent_turn_repo', ['uname'=> $cmd->agent_user_name])}}"> {{$cmd->agent_user_name}}</a></td>
...
<div class="table-container" id="table3">
  ...
  @foreach($Lmdata as $lmd)
      <tr scope="row">
          <td>{{$slno++ }}</td>
          <td> <a href="{{route('agent_turn_repo', ['uname'=> $lmd->agent_user_name])}}"> {{$lmd->agent_user_name}}</a></td>
...
<div class="table-container" id="table4">
  ...
  @foreach($Lwdata as $lwd)
      <tr scope="row">
          <td>{{$slno++ }}</td>
          <td> <a href="{{route('agent_turn_repo', ['uname'=> $lwd->agent_user_name])}}"> {{$lwd->agent_user_name}}</a></td>
...
<div class="table-container" id="table5">
  ...
  @foreach($Cwdata as $cwd)
      <tr scope="row">
          <td>{{$slno++ }}</td>
          <td> <a href="{{route('agent_turn_repo', ['uname'=> $cwd->agent_user_name])}}"> {{$cwd->agent_user_name}}</a></td>
...
<div class="table-container" id="table6">
  ...
  @foreach($Yddata as $ydt)
      <tr scope="row">
          <td>{{$slno++ }}</td>
          <td> <a href="{{route('agent_turn_repo', ['uname'=> $ydt->agent_user_name])}}"> {{$ydt->agent_user_name}}</a></td>
...
<div class="table-container" id="table7">
    ...
    <table class="table table-bordered" >
      ...
      @foreach($Tddata as $tdt)
          <tr scope="row">
              <td>{{$slno++ }}</td>
              <td> <a href="{{route('agent_turn_repo', ['uname'=> $tdt->agent_user_name])}}"> {{$tdt->agent_user_name}}</td>
